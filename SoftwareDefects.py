...
main = tkinter.Tk()
main.title("Software Defect Estimation")
...
def graph(event):
    ...
    bars = ('MLP Accuracy', 'RBF Accuracy', 'SVM Accuracy', 'Bagging Accuracy', 'Random Forest Accuracy', 'Naive Bayes Accuracy', 'Multinomial Accuracy')
...
title.config(bg='PaleVioletRed1', fg='white')  
...
baggingButton.place(x=600,y=230)
...
multinomialButton.place(x=50,y=390)
...
graphButton.place(x=600,y=390)
graphButton.config(font=font1)
graphButton.bind('<Button-1>',graph)


font1 = ('times', 12, 'bold')
text=Text(main,height=10,width=130)
scroll=Scrollbar(text)
text.configure(yscrollcommand=scroll.set)
text.place(x=10,y=470)
